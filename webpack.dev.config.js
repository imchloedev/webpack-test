...
module.exports = {
  entry: {
    app: "./src/index.js",
    subPage: "./src/sub/index.js", // 페이지 단위로 번들 파일을 만든다. --> index.html에 별도의 subPage 스크립트가 추가된다.
  },
  // 모듈의 의존성 그래프를 만드는 것으로, src/index.js 파일이 기본값으로 설정되며, 지정된 파일에 연관된 모듈과 라이브러리를 포함한 번들을 만든다.
  // app 으로 설정하면 main.js가 아닌 app.js로 변경된다.
